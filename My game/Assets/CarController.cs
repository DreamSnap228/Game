...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        _colliderFL.steerAngle = _maxAngle * Input.GetAxis("Horizont");
        _colliderFR.steerAngle = _maxAngle * Input.GetAxis("Horizont");

        RotateWheel(_colliderFL, _transformFL);
        RotateWheel(_colliderFR, _transformFR);
        RotateWheel(_colliderBL, _transformFL);
        RotateWheel(_colliderBR, _transformFL);
